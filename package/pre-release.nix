...
rustPlatform.buildRustPackage (finalAttrs: {
  ...
  src = fetchFromGitHub {
    ...
    hash = "sha256-dlk8djX/dJwkKfpSCV2J1F1IktbPU0PyW/v7fKJf5G4=";
  };
  ...
  cargoHash = "sha256-7fFeCepJXYPxonFMDMY401VPhGeWlJ9QwdEFTgpoaw0=";
  ...
  buildInputs =
    ...
    ++ lib.optionals supportCustomExtensions [
      rustWasm
    ];
  ...
  installPhase =
    ...
    + lib.optionalString buildRemoteServer ''
      install -Dm755 $release_target/remote_server $remote_server/bin/zed-remote-server-preview-$version
    ''
    + ''
      runHook postInstall
    '';
    ...
    tests =
      {
        remoteServerVersion = testers.testVersion {
          ...
          command = "zed-remote-server-preview-${finalAttrs.version} version";
        };
      }
